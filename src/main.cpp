		...
		try{
			...
			switch(sensor_id){
				...
				case SensorID_left_loop_duration_rotaryenc:
					/*
					audeng_state::audio_tracks[0].set_beats_per_loop(std::pow(2, ntrb_clamp_i64(sensor_value, min_loop_duration_2_exponent, max_loop_duration_2_exponent)));
					*/
					if(sensor_value == 1)
				...
				case SensorID_right_loop_duration_rotaryenc:
					/*
					audeng_state::audio_tracks[1].set_beats_per_loop(std::pow(2, ntrb_clamp_i64(sensor_value, min_loop_duration_2_exponent, max_loop_duration_2_exponent)));
					*/
					if(sensor_value == 1)
